...
case $RUN in
    ...
    vfsddpm_animalfaces_vit_lag_meanpatch_sigma)
      run 128 3 vfsddpm animalfaces vit lag mean_patch deterministic 8 5 4 8
      ;;
    vfsddpm_flowers_vit_lag_meanpatch_sigma)
      run 128 3 vfsddpm flowers vit lag mean_patch deterministic 8 5 4 8
      ;;
    vfsddpm_vggface_vit_lag_meanpatch_sigma)
      run 128 3 vfsddpm vggface vit lag mean_patch deterministic 8 5 4 8
      ;;
